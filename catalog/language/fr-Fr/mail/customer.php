...
$_['text_subject']        ='%s - Merci de vous inscrire';
$_['text_welcome']        ='Bienvenue et merci de vous enregistrer à %s!';
...
$_['text_services']       ='Lors de la connexion, vous pourrez accéder à d`autres services, y compris l`examen des commandes passées, l`impression de factures et l`édition des informations de votre compte.';
$_['text_thanks']         ='Merci,';
